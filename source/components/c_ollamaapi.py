...
def _default_callback(future, signal_object, *args):
    """Default callback function for the AsyncClien."""
...
class OllamaAPIComponent(c_component.Component):
    ...
    def run_task(self, prompt: str, model: str, callback_func: Callable):
        pass
